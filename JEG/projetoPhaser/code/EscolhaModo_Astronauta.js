Game.EscolhaModo_Astronauta = function(game){};
Game.EscolhaModo_Astronauta.prototype = {
	...
	create:function(game){
		...
		classicoButton = game.add.button(350, 350,"classico",this.Classic_Astronauta,this);
		classicoButton.anchor.setTo(0.5,0.5);
		//classicoButton.scale.set(0.5);
		//classicoButton.alpha = 0;

		competitivoButton = game.add.button(350, classicoButton.y-100,"competitivo",this.Competitivo_Astronauta,this);
...
//verificar se os estados estão adicionados no html game1, e se são chamados os scripts!!!
	Classic_Astronauta: function(game){
		//NIVEL 1 DO ATLETA
		this.game.state.start('Level1Astronauta');
	},
	Competitivo_Astronauta: function(game){
		this.game.state.start('AstronautaEndless');
